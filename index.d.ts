...
declare namespace ReactPDF {
  ...
  class FormCheckbox extends React.Component<TextInputProps> {}

  class FormRadio extends React.Component<TextInputProps> {}
...
declare const FormCheckbox: typeof ReactPDF.FormCheckbox;
declare const FormRadio: typeof ReactPDF.FormRadio;
